...
export function header(user=null) {
  ...
  return `<header class="site-header"><div class="shell-bar"><a class="brand" href="#/discover" aria-label="MyGita home">Gita <strong>Jyoti</strong></a><nav class="desktop-nav" aria-label="Main navigation">${nav}</nav><div class="shell-actions">${account}${mobileNavigation}</div></div></header>`;
}
