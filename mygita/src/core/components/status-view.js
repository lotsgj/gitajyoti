...
/** @param {{eyebrow?:string, title:string, message:string, action?:{label:string,href?:string,variant?:string,type?:"button"|"submit"|"reset",attributes?:string}}} options */
export function statusView({ eyebrow = "MyGita", title, message, action }) {
